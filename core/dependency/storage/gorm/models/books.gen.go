...
func newBook(db *gorm.DB, opts ...gen.DOOption) book {
	...
	_book.bookDo.UseModel(&table.Book{})
	...
	_book.PublishedAt = field.NewTime(tableName, "published_at")
	_book.CreatedBy = field.NewInt32(tableName, "created_by")
	_book.UpdatedBy = field.NewInt32(tableName, "updated_by")
	_book.CreatedAt = field.NewTime(tableName, "created_at")
	_book.UpdatedAt = field.NewTime(tableName, "updated_at")
	_book.Organization = field.NewInt32(tableName, "organization")
	_book.ChineseName = field.NewString(tableName, "chinese_name")
	_book.EnglishName = field.NewString(tableName, "english_name")
	_book.Order_ = field.NewInt64(tableName, "order")
...
func (b *book) updateTableName(table string) *book {
	...
	b.CreatedBy = field.NewInt32(table, "created_by")
	b.UpdatedBy = field.NewInt32(table, "updated_by")
	b.CreatedAt = field.NewTime(table, "created_at")
	b.UpdatedAt = field.NewTime(table, "updated_at")
	b.Organization = field.NewInt32(table, "organization")
	b.ChineseName = field.NewString(table, "chinese_name")
	b.EnglishName = field.NewString(table, "english_name")
	b.Order_ = field.NewInt64(table, "order")
...
func (b *book) fillFieldMap() {
	...
	b.fieldMap["organization"] = b.Organization
	b.fieldMap["chinese_name"] = b.ChineseName
	b.fieldMap["english_name"] = b.EnglishName
	b.fieldMap["order"] = b.Order_
}
...
type IBookDo interface {
	...
	Unscoped() IBookDo
	Create(values ...*table.Book) error
	CreateInBatches(values []*table.Book, batchSize int) error
	Save(values ...*table.Book) error
	First() (*table.Book, error)
	Take() (*table.Book, error)
	Last() (*table.Book, error)
	Find() ([]*table.Book, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*table.Book, err error)
	FindInBatches(result *[]*table.Book, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*table.Book) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*table.Book, error)
	FirstOrCreate() (*table.Book, error)
	FindByPage(offset int, limit int) (result []*table.Book, count int64, err error)
...
func (b bookDo) Create(values ...*table.Book) error {
	if len(values) == 0 {
		return nil
	}
...
func (b bookDo) CreateInBatches(values []*table.Book, batchSize int) error {
	return b.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (b bookDo) Save(values ...*table.Book) error {
	if len(values) == 0 {
		return nil
	}
...
func (b bookDo) First() (*table.Book, error) {
	if result, err := b.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*table.Book), nil
	}
}

func (b bookDo) Take() (*table.Book, error) {
...
func (b bookDo) Last() (*table.Book, error) {
...
func (b bookDo) Find() ([]*table.Book, error) {
	result, err := b.DO.Find()
	return result.([]*table.Book), err
}

func (b bookDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*table.Book, err error) {
	buf := make([]*table.Book, 0, batchSize)
...
func (b bookDo) FindInBatches(result *[]*table.Book, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (b bookDo) FirstOrInit() (*table.Book, error) {
...
func (b bookDo) FirstOrCreate() (*table.Book, error) {
...
func (b bookDo) FindByPage(offset int, limit int) (result []*table.Book, count int64, err error) {
...
func (b bookDo) Delete(models ...*table.Book) (result gen.ResultInfo, err error) {
