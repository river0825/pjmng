...
const TableNameGrammer = "grammers"

// Grammer mapped from table <grammers>
type Grammer struct {
	...
	AdminMaterial *int32          `gorm:"column:admin_material;type:integer" json:"admin_material"`
	...
	Order_        *int64          `gorm:"column:order;type:bigint" json:"order"`
}

// TableName Grammer's table name
func (*Grammer) TableName() string {
	return TableNameGrammer
}
