...
const TableNameEditorCategoryImage = "editor_category_images"

// EditorCategoryImage mapped from table <editor_category_images>
...
// TableName EditorCategoryImage's table name
func (*EditorCategoryImage) TableName() string {
	return TableNameEditorCategoryImage
}
