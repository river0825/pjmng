...
type Book struct {
	...
	ChineseName  *string    `gorm:"column:chinese_name;type:character varying(255)" json:"chinese_name"`
	EnglishName  *string    `gorm:"column:english_name;type:character varying(255)" json:"english_name"`
