...
// HasGroupsa applies the HasEdge predicate on the "groupsa" edge.
func HasGroupsa() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasGroupsaWith applies the HasEdge predicate on the "groupsa" edge with a given conditions (other predicates).
func HasGroupsaWith(preds ...predicate.Group) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newGroupsaStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
