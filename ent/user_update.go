...
func (uu *UserUpdate) AddGroupsaIDs(ids ...int) *UserUpdate {
	uu.mutation.AddGroupsaIDs(ids...)
	return uu
}

// AddGroupsa adds the "groupsa" edges to the Group entity.
func (uu *UserUpdate) AddGroupsa(g ...*Group) *UserUpdate {
	ids := make([]int, len(g))
	for i := range g {
		ids[i] = g[i].ID
	}
	return uu.AddGroupsaIDs(ids...)
}
...
// ClearGroupsa clears all "groupsa" edges to the Group entity.
func (uu *UserUpdate) ClearGroupsa() *UserUpdate {
	uu.mutation.ClearGroupsa()
	return uu
}

// RemoveGroupsaIDs removes the "groupsa" edge to Group entities by IDs.
func (uu *UserUpdate) RemoveGroupsaIDs(ids ...int) *UserUpdate {
	uu.mutation.RemoveGroupsaIDs(ids...)
	return uu
}

// RemoveGroupsa removes "groupsa" edges to Group entities.
func (uu *UserUpdate) RemoveGroupsa(g ...*Group) *UserUpdate {
	ids := make([]int, len(g))
	for i := range g {
		ids[i] = g[i].ID
	}
	return uu.RemoveGroupsaIDs(ids...)
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if uu.mutation.GroupsaCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   user.GroupsaTable,
			Columns: user.GroupsaPrimaryKey,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := uu.mutation.RemovedGroupsaIDs(); len(nodes) > 0 && !uu.mutation.GroupsaCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   user.GroupsaTable,
	...
	if nodes := uu.mutation.GroupsaIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   user.GroupsaTable,
...
// AddGroupsaIDs adds the "groupsa" edge to the Group entity by IDs.
func (uuo *UserUpdateOne) AddGroupsaIDs(ids ...int) *UserUpdateOne {
	uuo.mutation.AddGroupsaIDs(ids...)
	return uuo
}

// AddGroupsa adds the "groupsa" edges to the Group entity.
func (uuo *UserUpdateOne) AddGroupsa(g ...*Group) *UserUpdateOne {
	ids := make([]int, len(g))
	for i := range g {
		ids[i] = g[i].ID
	}
	return uuo.AddGroupsaIDs(ids...)
}
...
// ClearGroupsa clears all "groupsa" edges to the Group entity.
func (uuo *UserUpdateOne) ClearGroupsa() *UserUpdateOne {
	uuo.mutation.ClearGroupsa()
	return uuo
}

// RemoveGroupsaIDs removes the "groupsa" edge to Group entities by IDs.
func (uuo *UserUpdateOne) RemoveGroupsaIDs(ids ...int) *UserUpdateOne {
	uuo.mutation.RemoveGroupsaIDs(ids...)
	return uuo
}

// RemoveGroupsa removes "groupsa" edges to Group entities.
func (uuo *UserUpdateOne) RemoveGroupsa(g ...*Group) *UserUpdateOne {
	ids := make([]int, len(g))
	for i := range g {
		ids[i] = g[i].ID
	}
	return uuo.RemoveGroupsaIDs(ids...)
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if uuo.mutation.GroupsaCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   user.GroupsaTable,
	...
	if nodes := uuo.mutation.RemovedGroupsaIDs(); len(nodes) > 0 && !uuo.mutation.GroupsaCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   user.GroupsaTable,
	...
	if nodes := uuo.mutation.GroupsaIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   user.GroupsaTable,
